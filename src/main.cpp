...
uint256 hashGenesisBlock("0x0000002bdf4ca3a0b3fec305724006871ec5e683da5d70d9fe7a22f1f967e7f3");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        // 
        // 
        hashGenesisBlock = uint256("0x0000002bdf4ca3a0b3fec305724006871ec5e683da5d70d9fe7a22f1f967e7f3");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // 
        const char* pszTimestamp = "January 19 2015 GeoCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 512 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04ffff001d01042c43617373756269616e20466f756e646174696f6e20666f72204469676974616c2050726f6669742032303134") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1421651783;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 53830674;
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x9b36cc80c80b9f589a7c99f878b02c9d7dde4a0c717ac7dc8fc89ee71a329c26"));
