...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 9748 or testnet: 19748)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 9749 or testnet: 19749)") + "\n" +
        ...
        "\n" + _("SSL options: (see the GeoCoin Wiki for SSL setup instructions)") + "\n" +
